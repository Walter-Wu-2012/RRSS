...
skip1 = Button(frame2, text='SKIP', padx=j).grid(row=8, column=1, columnspan=2)
...
skip2 = Button(frame3, text='SKIP', padx=j).grid(row=8, column=3, columnspan=2)
...
skip3 = Button(frame4, text='SKIP', padx=j).grid(row=8, column=5, columnspan=2)
