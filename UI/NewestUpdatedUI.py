...
class Settings(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label = ttk.Label(self, text="Breakfirst time", font=SMALLFONT)
        label.grid(row=6, column=2, padx=10, pady=10)

        BFhour = tk.Text(self, font=NORMALFONT, bg="light cyan", height=1, width=5)
        BFhour.grid(row=6, column=3, padx=10, pady=10)
        BFhour.insert(END, str(Bhour) + ":" + str(Bmin))

        label = ttk.Label(self, text="Lunch time", font=SMALLFONT)
        label.grid(row=7, column=2, padx=10, pady=10)

        Lunchhour = tk.Text(self, font=NORMALFONT, bg="light cyan", height=1, width=5)
        Lunchhour.grid(row=7, column=3, padx=10, pady=10)
        Lunchhour.insert(END, str(Lhour) + ":" + str(Lmin))

        label = ttk.Label(self, text="Dinner time", font=SMALLFONT)
        label.grid(row=8, column=2, padx=10, pady=10)

        Dinnerhour = tk.Text(self, font=NORMALFONT, bg="light cyan", height=1, width=5)
        Dinnerhour.grid(row=8, column=3, padx=10, pady=10)
        Dinnerhour.insert(END, str(Dhour) + ":" + str(Dmin))

        label = ttk.Label(self, text="Sleep time", font=SMALLFONT)
        label.grid(row=9, column=2, padx=10, pady=10)
        label = ttk.Label(self, text="Until", font=SMALLFONT)
        label.grid(row=9, column=4, padx=10, pady=10)

        sleepbegin = tk.Text(self, font=NORMALFONT, bg="light cyan", height=1, width=5)
        sleepbegin.grid(row=9, column=3, padx=10, pady=10)
        sleepbegin.insert(END, str(Beginhour) + ":" + str(Beginmin))

        sleepend = tk.Text(self, font=NORMALFONT, bg="light cyan", height=1, width=5)
        sleepend.grid(row=9, column=5, padx=10, pady=10)
        sleepend.insert(END, str(Endhour) + ":" + str(Endmin))
