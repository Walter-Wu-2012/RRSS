...
class MoodPredictionNet(nn.Module):
    def __init__(self, n_input, n_output):
        ...
        self.conv_sti1 = nn.Conv2d(133, 256, 3, 1)
        self.conv_sti2 = nn.Conv2d(256, 512, 3, 2)
        self.conv_sti3 = nn.Conv2d(512, 256, 3, 2)
        self.conv_sti4 = nn.Conv2d(256, 128, 3, 2)

        self.conv_bm1 = nn.Conv2d(5, 32, 3, 1)
        self.conv_bm2 = nn.Conv2d(32, 64, 3, 2)
        self.conv_bm3 = nn.Conv2d(64, 128, 3, 2)

        self.conv_px1 = nn.Conv2d(256, 128, 3, 1)
    ...
    def forward(self, past_event,future_event,past_mood):
        event = torch.cat([past_event, future_event], dim=3)
        ...
        basic_m = F.relu(self.conv_bm1(past_mood))
